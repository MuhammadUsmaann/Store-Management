  ...
  public  class Helper
    {
        ...
        {
            AccessRight right = new AccessRightService().GetSingle(new AccessRight { FormID = form.ToString(), UserID = CurrentUser.User.UserID });
        ...
        {
            return new LocationService().GetAll().ToList();
        }

        public static List<SaleStatus> LoadSaleStatuses()
        {
            return new SaleStatusService().GetAll().ToList();
        }

        public static List<Customer> LoadCustomers()
        {
            return new CustomerService().GetAll().ToList();
        }

        public static List<Employee> LoadEmployees()
        {
            return new EmployeeService().GetAll().ToList();
        }
        ...
        public static List<Tax> LoadTaxes()
        {
            ...
            taxes.AddRange(new TaxService().GetAll().ToList());
        ...
        {
            return new PaymentModeService().GetAll().ToList();
        }
        public static string Encrypt(string toEncrypt, bool useHashing = true)
        {
            ...
            string key = storeManager.BusinessLayer.Interfaces.RepositoryConfiguration.SECURITYKEY;
