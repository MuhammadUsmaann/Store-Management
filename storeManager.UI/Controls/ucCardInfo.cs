...
namespace storeManager.UI.Controls
{
    public partial class ucCardInfo : UserControl
    {
        ...
        {
            Customer cust = _customer.GetSingle(new Customer { CustomerID = custID });
        ...
        {
            Supplier supplier = _supplier.GetSingle(new Supplier { SupplierID = supplierID });
        ...
        {
            Employee employee = _employee.GetSingle(new Employee { EmployeeID = _employeeID });
